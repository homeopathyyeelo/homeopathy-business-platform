...
export default function Features() {
  ...
  useEffect(() => {
    ...
    metaDescription.setAttribute('content', 'Discover all features of our AI-driven ERP system built specifically for homeopathy and pharmaceutical stores. From inventory management to customer engagement, everything you need in one intelligent platform.');
        ...
        <section className="py-20 px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Button asChild variant="outline" size="lg" className="px-8">
                <Link to="/settings">Contact Sales</Link>
              </Button>
            </div>
          </div>
        </section>
