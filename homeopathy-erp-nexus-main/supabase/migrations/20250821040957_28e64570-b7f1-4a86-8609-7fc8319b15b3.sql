...
-- Create policies for inventory (without IF NOT EXISTS as it's not supported)
...
-- Fix function search paths for all update timestamp functions
...
CREATE OR REPLACE FUNCTION public.update_supplier_discounts_timestamp()
RETURNS trigger
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
