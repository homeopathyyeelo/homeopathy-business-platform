...
export default function HRPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900"> HR</h1>
        <p className="text-gray-500 mt-1">Human resources</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="text-center py-12">
          ...
          <div className="text-2xl font-bold text-gray-900 mb-2">HR</div>
          <div className="text-gray-500 mb-6">Human resources</div>
