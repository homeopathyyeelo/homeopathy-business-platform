...
let User = (() => {
    ...
    let _shopId_decorators;
    let _shopId_initializers = [];
    let _shopId_extraInitializers = [];
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.lastLogin = (__runInitializers(this, _shopId_extraInitializers), __runInitializers(this, _lastLogin_initializers, void 0));
    ...
    (() => {
        ...
        _role_decorators = [(0, typeorm_1.Column)({ default: 'SALES_REP' })];
        ...
        _shopId_decorators = [(0, typeorm_1.Column)({ type: 'uuid', nullable: true })];
        ...
        __esDecorate(null, null, _shopId_decorators, { kind: "field", name: "shopId", static: false, private: false, access: { has: obj => "shopId" in obj, get: obj => obj.shopId, set: (obj, value) => { obj.shopId = value; } }, metadata: _metadata }, _shopId_initializers, _shopId_extraInitializers);
