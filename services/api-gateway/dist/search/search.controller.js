...
let SearchController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)('search'), (0, common_1.Controller)('search'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    (() => {
        ...
        _search_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Global search across all entities' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Search results' })];
