...
func main() {
	...
	// Initialize handlers that we know work
	...
	bugsHandler := handlers.NewBugsHandler(services.NewBugService(db))
	...
	api := r.Group("/api")
	{
		...
		{
			masters.GET("/categories", categoryHandler.GetCategories)
