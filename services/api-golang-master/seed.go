	...
	roles := []Role{
		{
			...
			Permissions: []Permission{
				...
				{Code: "SOCIAL_GMB_ALL", Name: "All GMB Access", Module: "social", Action: "all"},
			},
			IsSystemRole: true,
			IsActive:     true,
		},
		{
			...
			Permissions: []Permission{
				{Code: "SOCIAL_GMB_VIEW", Name: "View GMB", Module: "social", Action: "view"},
				{Code: "SOCIAL_GMB_CREATE", Name: "Create GMB Posts", Module: "social", Action: "create"},
				{Code: "SOCIAL_GMB_PUBLISH", Name: "Publish GMB Posts", Module: "social", Action: "publish"},
				{Code: "SOCIAL_GMB_ACCOUNTS", Name: "Manage GMB Accounts", Module: "social", Action: "accounts"},
				{Code: "SOCIAL_GMB_AUDIT", Name: "View GMB Audit", Module: "social", Action: "audit"},
			},
			IsActive: true,
		},
		{
